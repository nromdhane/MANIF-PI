...
var ToastyComponent = (function () {
    ...
    /**
       ...
       * directive is instantiated.
       */
    ToastyComponent.prototype.ngOnInit = /**
       * `ngOnInit` is called right after the directive's data-bound properties have been checked for the
       * first time, and before any of its children have been checked. It is invoked only once when the
       * directive is instantiated.
       */
    ...
    /**
       ...
       * This method executes click option callback associated with this Toast.
       */
    ToastyComponent.prototype.clickToast = /**
       * Event listener of 'clickToast' event comes from ToastyComponent.
       * This method executes click option callback associated with this Toast.
       */
    function (toast) {
    ...
    /**
       ...
       * This method removes ToastComponent associated with this Toast.
       */
    ToastyComponent.prototype.closeToast = /**
       * Event listener of 'closeToast' event comes from ToastyComponent.
       * This method removes ToastComponent associated with this Toast.
       */
    function (toast) {
    ...
    /**
       ...
       * @param id is unique identifier of Toast
       */
    ToastyComponent.prototype.clear = /**
       * Clear individual toast by id
       * @param id is unique identifier of Toast
       */
    function (id) {
    ...
    /**
       * Clear all toasts
       */
    ToastyComponent.prototype.clearAll = /**
       * Clear all toasts
       */
    function () {
        var _this = this;
    ...
    /**
       * Custom setTimeout function for specific setTimeouts on individual toasts.
       */
    ToastyComponent.prototype._setTimeout = /**
       * Custom setTimeout function for specific setTimeouts on individual toasts.
       */
    function (toast) {
        var _this = this;
